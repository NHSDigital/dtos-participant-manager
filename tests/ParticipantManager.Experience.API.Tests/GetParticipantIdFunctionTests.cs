...
public class GetParticipantIdFunctionTests
{
    ...
    public GetParticipantIdFunctionTests()
    {
        ...
        _function = new GetParticipantIdFunction(_loggerMock.Object, _crudApiClient.Object, _mockTokenService.Object,
    ...
    public async Task GetParticipantId_ParticipantIsNull_ReturnsNotFound()
    {
        ...
        _mockTokenService.Setup(s => s.ValidateToken(It.IsAny<HttpRequestData>()))
            .ReturnsAsync(AccessTokenResult.Success(principal));
        _crudApiClient.Setup(s => s.GetParticipantByNhsNumberAsync("12345678"))
